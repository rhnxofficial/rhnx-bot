...
Ketik *.menu <folder>* untuk melihat fitur di kategori tersebut.`;
   ...
   await conn.sendMessageModify(m.chat, teks, m, {
          title: bot.name,
          largeThumb: true,
          thumbnail: 'https://cdn.rhnx.xyz/paUukNKHa.jpg',
          url: '',
          mentions: [jid]
        });
          await conn.sendvn(
    m.chat, "https://files.catbox.moe/ijxwa4.opus",
    m
  );
          return;
      }
  ...
  await conn.sendMessage(
    ...
    {
      video: {
        url: "https://raw.githubusercontent.com/rhnxofficial/Uploader/main/uploader/rhnx-vmvB.mp4"
      },
      caption: styleText(teks),
      gifPlayback: true,
      mentions: [jid]
    },
    { quoted: m }
  ...
  await conn.sendvn(
    m.chat,
    "https://files.catbox.moe/ijxwa4.opus",
    m
  );
