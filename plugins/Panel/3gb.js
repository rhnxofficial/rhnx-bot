    ...
    try {
      ...
      const belipanel = {
        ...
        data: {
          ...
          ram: "3GB",
          harga: waktuPanel.threegb.harga,
          notification: false
        }
      };
      ...
      await saveToGithub({
        ...
        path: dataPanel.path,
        newData: belipanel,
        message: `add buyer panel 3GB ${username}`
      });
...
Terimakasih Telah Mempercayai *${panel.name}*`);
      ...
      m.reply(`✅ Panel 3GB dengan nama ${username} Berhasil Di Buat`);
    } catch (err) {
      console.error(err);
      m.reply("❌ Gagal membuat panel 3GB");
    }
  }
};
